<article class="post ttm-blog-single mt-b clearfix">
<div class="bg-light rounded p-3 mb-4"><ul class="usinf fs-13">
...
[not-logged]
<article class="post ttm-blog-single mb-5 clearfix">
    
<div class="yhGdtsl mb-4">Изменить информацию</div>
...
<button class="submit ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor" name="submit" type="submit">Сохранить изменения</button>
