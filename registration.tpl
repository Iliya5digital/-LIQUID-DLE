...
<button class="submit ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor" name="submit" type="submit">Зарегистрироваться</button>
